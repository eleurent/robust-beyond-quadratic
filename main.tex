...
In both experiments, we used $\gamma=0.9$ and $\delta=0.9$.
The perturbations were sampled uniformly in $[-0.1, 0.1]^r$ while the measurements are gaussian with covariance $\Sigma_r = 0.1 I_s$.
