...
% Industrial setting: data-driven but good initial performances
...
\begin{align*}
    \theta_{N,\lambda} - \theta = G_{N, \lambda}^{-1}\sum_{n=1}^N \Phi_n^\transp \Sigma_p^{-1}\eta_n - \lambda G_{N, \lambda}^{-1}\Sigma_d\theta 
\end{align*}
\end{lemma}
...
&+ \lambda\|G_{N, \lambda}^{-1}\Sigma_d\|_1\|\theta\|_\infty \nonumber
\end{align}
...
% Let $\Gamma$ be a Gaussian random variable which is independent of all other random variables and whose covariance is $\Sigma^{-1}$. (in our estimator, $\Sigma = \lambda\Sigma_d$).
...
\begin{align*}
    \| \theta_{N,\lambda}  - \theta\|_{G_{N,\lambda}} &\leq \left\|\sum_{n=1}^N \Phi_n^\transp \Sigma_p^{-1}\eta_n\right\|_{G_{N, \lambda}^{-1}} + \lambda\|\Sigma_d\theta\|_{G_{N, \lambda}^{-1}}
\end{align*}

By applying \autoref{prop:concentration}, we obtain:
\begin{align*}
    \| \theta_{N,\lambda}  - \theta\|_{G_{N,\lambda}} &\leq 
     + \lambda\|\Sigma_d\theta\|_{G_{N, \lambda}^{-1}}
\end{align*}
\end{proof}
