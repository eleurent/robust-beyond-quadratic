...
\end{equation*}
where $\Delta_\omega$ is a constant specified in the proof, which corresponds to an irreductible suboptimality suffered from being robust to instantaneous perturbations $\omega(t)$, with knowledge of $A(\theta)$. % $\max_a \sum_n \min_\omega$
\end{theorem}
