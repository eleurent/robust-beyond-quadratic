...
We leverage known techniques from the uncertain system simulation literature to efficiently compute such a predictor.
...
However, \citet{leurent2019interval} showed that this predictor can have very unstable dynamics, even for stable systems, which can cause a rapid build-up of uncertainty and produce over-cautious behaviours. They propose an enhanced predictor which produces tighter and more stable predictions, and whose stability can be assessed by solving a linear matrix inequality, at the price of an additional requirement:
